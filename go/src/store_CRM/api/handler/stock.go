...
// func (h *Handler) TransferStockProduct(c *gin.Context) {
// 	var transferStockProductRequest models.TransferStockProductRequest
// 	err := c.ShouldBindJSON(transferStockProductRequest)
// 	if err != nil {
